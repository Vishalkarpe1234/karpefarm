  ...
  const contactInfo = [
    {
      icon: FiMapPin,
      title: 'Farm Location',
      lines: ['Karpe Farm House, Malwadgoan Road,', 'Kamalpur, Takalibhan, Shrirampur 413725', 'Maharashtra, India'],
    ...
    },
    {
      icon: FiPhone,
      title: 'Phone',
      lines: ['+91 96374 94175', '+91 91309 31719', 'Mon-Sat: 6AM - 7PM'],
      color: 'text-blue-600',
      bg: 'bg-blue-50',
    },
    {
      icon: FiMail,
      title: 'Email',
      lines: ['hivetech1010@gmail.com', 'karpevishal2712001@gmail.com'],
