...
const team = [
  {
    name: 'Vinayak Vishwanath Karpe',
    role: 'Founder & Owner',
    title: 'Master Farmer — 30+ Years Experience',
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member, i) => (
              ...
              >
                {/* Card Top Gradient */}
                <div className={`h-36 bg-gradient-to-br ${member.color} relative flex items-center justify-center`}>
                  <span className="text-5xl">{member.badge}</span>
